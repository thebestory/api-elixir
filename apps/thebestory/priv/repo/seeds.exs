...
#
#     TheBestory.Repo.insert!(%TheBestory.SomeSchema{})
#
...
defmodule TheBestory.Repo.Seed do
  ...
  def insert do
    ...
    stories = insert_stories()
    {:ok, users, topics, stories}
  end

  def clear do
    Repo.delete_all(Schema.Story)
    Repo.delete_all(Schema.Topic)
